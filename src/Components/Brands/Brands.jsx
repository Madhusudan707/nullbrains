        ...
        <div className='flex flex-col items-center px-24 mt-36 '>
            ...
            <div >
                <ul className='flex justify-between mt-12'>
                    ...
                    <li><img src='/images/logo/youtube.png' className='w-3/4' alt='youtube'/></li>
                    <li><img src='/images/logo/slack.png' className='w-3/4' alt='slack'/></li>
                    <li><img src='/images/logo/shopify.png' className='w-3/4' alt='shopify'/></li>
